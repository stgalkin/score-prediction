...
return [
    ...
    */
    'managers' => [
        'default' => [
            ...
            'namespaces' => [],
            'paths' => [
                base_path('app/Components/Soccer/Infrastructure/Doctrine/Mapping'),
            ],
    ...
    */
    'custom_types' => [
       ...
       GameIdType::NAME => GameIdType::class,
       TeamIdType::NAME => TeamIdType::class,
       NameType::NAME => NameType::class,
       WeekType::NAME => WeekType::class,
       GoalsType::NAME => GoalsType::class,
    ],
    /*
    |--------------------------------------------------------------------------
